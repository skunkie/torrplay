...
func TestGetBaseURLForwardedHost(t *testing.T) {
	tests := []struct {
		name     string
		host     string
		expected string
...
func TestBuildPosterURLStripsDirectories(t *testing.T) {
...
func TestAreSequentialFilesRejectsRepeatedNumbers(t *testing.T) {

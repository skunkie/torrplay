...
func TestSpeedMonitor_Update(t *testing.T) {
	t.Run("calculates speeds", func(t *testing.T) {
		sm := newSpeedMonitor()
	...
	t.Run("ignores non-positive elapsed time", func(t *testing.T) {
		sm := newSpeedMonitor()
		sm.update(1000, 500)
...
func TestSpeedMonitorLifecycle(t *testing.T) {
	sm := newSpeedMonitor()
